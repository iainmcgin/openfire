...
public abstract class AbstractInvitationResponseMessage extends StringMapBasedMessage {

	private static final String PEER_USERNAME_KEY = "name"; 
	
	private String peerUserName;
	
	public AbstractInvitationResponseMessage() {
		peerUserName = "";
	}
	
	@Override
	protected void interpretAttributeMap(StringKeyedAttributeMap map) {
		peerUserName = map.getStringAttributeValue(PEER_USERNAME_KEY);
	}

	@Override
	protected void populateAttributeMap(StringKeyedAttributeMap map) {
		map.addAttribute(PEER_USERNAME_KEY, new StringAttributeValue(peerUserName));
	}
